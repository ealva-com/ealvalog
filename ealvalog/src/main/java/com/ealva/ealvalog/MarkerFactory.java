...
/**
 * Creates and maintains {@link com.ealva.ealvalog.Marker} instances
 * <p>
...
public interface MarkerFactory {
   ...
   */
  @NotNull com.ealva.ealvalog.Marker get(@NotNull String name);
  ...
  /**
   * Remove the named {@link com.ealva.ealvalog.Marker} from the factory
   * @param name marker name to remove or create
   *
   * @return true if the {@link com.ealva.ealvalog.Marker} was removed, false if it was not contained in this factory
   */
  boolean orphan(@NotNull String name);

  /**
   * Create a {@link com.ealva.ealvalog.Marker} instance but do not keep a reference in this factory
   *
   * @param name name of the marker to be created
   *
   * @return a new marker instance that is not retained by this factory
   */
  @NotNull com.ealva.ealvalog.Marker makeOrphan(@NotNull String name);
}
