 ...
 * <p>
 * Our experience with production systems, online and batch, has shown us many examples of developers not logging as appropriate
 ...
 * methods and possibly only for areas measured as time critical. Given that most of the work is done via this well tested framework,
 * there is little downside and can be a huge upside to some small custom implementations.
 *
