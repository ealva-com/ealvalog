...
/**
 * This is where {@link Logger} instances are obtained. This singleton must be configured with a concrete implementation of {@link
...
public class Loggers {
  ...
  /**
   * Get a {@link Logger} inferring the name from the call stack
   *
  ...
  /**
   * Get a {@link Logger} for {@code aClass}, using the class name
   *
   ...
   */
  public static void log(final @NotNull LogLevel level, final @NotNull String msg) {
   ...
   * @param msg    log msg which is unaltered
   */
  public static void log(@NotNull LogLevel level, @NotNull Marker marker, @NotNull String msg) {
    loggerFactory.get(LogUtil.getCallerClassNameStripInner(STACK_DEPTH)).log(level, marker, msg);
  }
   ...
   * @param msg       log msg which is unaltered
   */
  public static void log(@NotNull LogLevel level, @NotNull Throwable throwable, @NotNull String msg) {
    loggerFactory.get(LogUtil.getCallerClassNameStripInner(STACK_DEPTH)).log(level, throwable, msg);
  }
   ...
   * @param msg       log msg which is unaltered
   */
  public static void log(@NotNull LogLevel level, @NotNull Marker marker, @NotNull Throwable throwable, @NotNull String msg) {
    loggerFactory.get(LogUtil.getCallerClassNameStripInner(STACK_DEPTH)).log(level, marker, throwable, msg);
  }
   ...
   */
  public static void log(@NotNull LogLevel level, @NotNull Marker marker, @NotNull String format, @NotNull Object... formatArgs) {
    loggerFactory.get(LogUtil.getCallerClassNameStripInner(STACK_DEPTH)).log(level, marker, format, formatArgs);
  }
   ...
   * @param formatArgs arguments passed to {@link Formatter#format(String, Object...)}
   */
  public static void log(@NotNull LogLevel level, @NotNull Throwable throwable, @NotNull String format, @NotNull Object... formatArgs) {
    loggerFactory.get(LogUtil.getCallerClassNameStripInner(STACK_DEPTH)).log(level, throwable, format, formatArgs);
  }
