 ...
 */
public enum AlwaysAcceptFilter implements LoggerFilter {
  INSTANCE;
   ...
   *
   * @return the filter parameter if not null, else {@link AlwaysAcceptFilter#INSTANCE}
   */
  public static @NotNull LoggerFilter nullToAlwaysAccept(final @Nullable LoggerFilter filter) {
