...
public class CoreLoggerTest {
  ...
  @SuppressWarnings("WeakerAccess") @Mock Bridge bridge;
  ...
  public void testPrintLog() throws Exception {
    CoreLogger<Bridge> logger = new CoreLoggerForTest("LoggerName", bridge);
  ...
  private static class CoreLoggerForTest extends CoreLogger<Bridge> {
