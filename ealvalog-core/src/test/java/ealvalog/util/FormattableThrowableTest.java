...
public class FormattableThrowableTest {
  ...
  public void testNull() {
    FormattableThrowable formattableThrowable = FormattableThrowable.make(null);
  ...
  public void testFormat() {
    FormattableThrowable formattableThrowable = FormattableThrowable.make(new IllegalArgumentException("Blah"));
    formattableThrowable.formatTo(formatter, 0, -1, -1);
